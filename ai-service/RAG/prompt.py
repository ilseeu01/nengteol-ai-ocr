...
class NutritionRAGSystem:
    ...
    def call_clova_ai(self, prompt):
        """langchain ChatClovaX를 사용한 클로바 AI 호출"""
        try:
            from langchain_naver import ChatClovaX
            
            llm = ChatClovaX(
                model=CLOVA_CONFIG["model"],
                api_key=CLOVA_CONFIG["api_key"],
            ...
            print("langchain_naver가 설치되지 않았습니다.")
            return "langchain_naver 패키지가 필요합니다."
        except Exception as e:
